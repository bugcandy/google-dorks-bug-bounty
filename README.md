...
> site:"example[.]com" inurl:url= | inurl:return= | inurl:next= | inurl:redirect= | inurl:redir= | inurl:ret= | inurl:r2= | inurl:page= inurl:& inurl:http site:example.com | inurl:return_to= | | inurl:return_uri= | inurl:redirect_uri= | inurl:prev= | inurl:prev_page= | inurl:next_page= | inurl:site= | inurl:next= | inurl:view= | inurl:back= | inurl:to= | inurl:source= | inurl:from= | inurl:continue= | inurl:continue_to= |inurl:location= | inurl:route= | inurl:follow= | inurl:success_url= | inurl:failure_url= | inurl:callback= |inurl:cb= | inurl:ret=
